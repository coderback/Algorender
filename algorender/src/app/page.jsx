...
function Home() {
  ...
  const dataStructures = [
    ...
    {
      name: 'Trie',
      description: 'A tree-like data structure used to store and retrieve strings.',
    ...
    {
      name: 'Directed Graph',
      description: 'A graph where edges have a specific direction.',
      path: '/visualisers/directed-graph',
      category: 'Graph-Based',
      timeComplexity: { best: 'O(1)', average: 'O(V + E)', worst: 'O(V + E)' },
      spaceComplexity: 'O(V + E)'
    },
    {
      name: 'Weighted Graph',
      description: 'A graph where edges have associated weights.',
      path: '/visualisers/weighted-graph',
      category: 'Graph-Based',
      timeComplexity: { best: 'O(1)', average: 'O(V + E)', worst: 'O(V + E)' },
      spaceComplexity: 'O(V + E)'
    },
