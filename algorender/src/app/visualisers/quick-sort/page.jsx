...
export default function QuickSortVisualiser() {
  ...
  return (
    <Layout
      ...
      description="Visualise the quick sort algorithm step by step."
                ...
                <div
                  ...
                  className={`w-12 flex flex-col items-center transition-all duration-300 ${
                    sortedIndices.includes(index)
                      ...
                      ? 'bg-yellow-500'
                      : partitionIndices.includes(index)
                      ? 'bg-blue-500'
                      : 'bg-gray-200'
                  }`}
                  style={{
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-3 text-gray-600">
              <div className="flex items-start space-x-2">
                ...
                <span>Choose a pivot element</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
