...
export default function DirectedGraphVisualiser() {
  ...
  const drawGraph = () => {
    ...
    graph.edges.forEach(edge => {
      ...
      ctx.closePath();
      ctx.fillStyle = selectedEdge === edge ? '#3B82F6' : '#E5E7EB';
      ctx.fill();
  ...
  return (
    <Layout
      title="Directed Graph Visualiser"
      description="Visualise directed graph operations with nodes and weighted edges."
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-gray-50 rounded-xl p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Directed Graph</h2>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span>Add Edge: O(1) - Connect two vertices with direction</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span>DFS: O(V + E) - Visit all reachable vertices</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              {selectedNode && (
                <div className="space-y-3">
                  ...
                  <Button
                    onClick={() => dfs(selectedNode.id)}
                    variant="primary"
                    fullWidth
                  >
                    DFS from Node {selectedNode.id}
                  </Button>
                </div>
              )}
            </div>
